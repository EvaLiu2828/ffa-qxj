 ...
 * @returns {*}
 */
function indexedDBDAOFactory(DBName, verStorageName, cusStorageName) {
    "use strict";
    ...
    var db; //db对象
    var DBName = DBName;//DBconfig.DBName; //数据库名称
    var verStorageName = verStorageName;//DBconfig.verStorageName;	//更新时间表
    var storageName = cusStorageName;//DBconfig.cusStorageName; 	//操作表
    ...
    return {
         ...
         * @returns {*}
         */
        updateLocalDB: function (a, u, d, updateTime, managerId) {
            //参数检查
            ...
            // 区别销售经理
            var itemObj = {};
            itemObj.updateTime = updateTime;
            itemObj.managerId = managerId;
            var updVerReq = tx.objectStore(verStorageName).put(itemObj);
