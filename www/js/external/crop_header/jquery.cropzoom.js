...
(function ($) {
    ...
    $.fn.cropzoom = function (options) {
        ...
        return this
            .each(function () {
				...
				//wangjunbao update width 8 update 0 height 8 update 0
                        ...
                        .draggable({
                            ...
                            stop: function (event, ui) {
                                ...
                                if ($options.selector.hideOverlayOnDragAndResize)
									//update wangjunbao  annimation hideOverlay
                                    hideOverlay();
                            ...
                            resize: function (event, ui) {
                             ...
                             getData('selector').w = $selector
                                ...
                                getData('selector').h = $selector
                                    .height();
									console.log("width"+getData('selector').w);
									console.log("height"+getData('selector').h);
                                makeOverlayPositions(ui);
                                showInfo();
    ...
    $.fn.extend({
		...
		getPhotoParams:function(custom){
			var _self = $(this);
			return _self.cropzoom.getParameters(_self, custom);
			//console.log(_self.cropzoom.getParameters(_self, custom));
		},
