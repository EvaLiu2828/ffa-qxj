...
var customerService = (function(){
    ...
    var getCustomerListParams = function(flag, data){
        ...
        if(flag === 0){
            ...
            if (cusCount) params.cusCount = cusCount;
            //params.timestamp = "";
        }else{
            throw Error("未知请求");
        }
    ...
    return {
        ...
        getCustomerList:function(data,successFun,errorFun){
            http_post(get_customerlist_interface,getCustomerListParams(0, data),successFun,errorFun)
        },
         ...
         * @param errorFun
         */
        queryProgress:function(data,successFun,errorFun){
            http_post(query_progress_interface,getQueryProgressParams(2, data),successFun,errorFun)
        },
        /**
         *修改
         * @param data
         ...
         * @param errorFun
         */
        updateCustomer:function(data, successFun, errorFun){
            http_post(update_customer_interface,getUpdateCustomerParams(0,data),successFun,errorFun);
        },
        /**
         * 删除
         * @param data
         ...
         * @param errorFun
         */
        deleteCustomer:function(data, successFun, errorFun){
            http_post(update_customer_interface,getUpdateCustomerParams(1,data),successFun,errorFun);
        },
         ...
         * @param errorFun
         */
        updateCommtionTime:function(data, successFun, errorFun){
            http_post(update_customer_interface,getUpdateCustomerParams(2,data),successFun,errorFun);
        },
         ...
         * @param errorFun
         */
        addCustomer:function(data,successFun,errorFun){
            http_post(update_customer_interface,getUpdateCustomerParams(3,data),successFun,errorFun);
        },
        /**
         * 占坑
         * @param data
        ...
        occupyCustomer:function(data,successFun,errorFun){
            http_post( post_occupation_interface,getPostOccupationParams(data),successFun,errorFun)
        },
        /**
         * 添加电话
         * @param data
         ...
         * @param errorFun
         */
        addPhone:function(data,successFun,errorFun){
            http_post(add_phonenumber_interface,getAddPhonenumberParams(data),successFun,errorFun)
        },
        /**
         * 查询客户详细信息
         * @param data
